            ...
            <div className="container">
                <div className="row1 news-trending rounded">
                    ...
                    <div className="news-slider">
                        <div className="swiper newsSwiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                            ...
                            <div className="swiper-button-next d-lg-flex d-none" ></div>
                            <div className="swiper-button-prev d-lg-flex d-none swiper-button-disabled" ></div>
                        </div>
                    </div>
                </div>
            </div>
