...
use App\Models\SbAcademia\AcademiaCategory;
use App\Models\SbAcademia\AcademiaCategoryLanguage;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\Auth;

class PublicAcademiaCategoryController extends Controller
{
    /**
    ...
    public function index(Request $request): Response
    {
        ...
        $response = AcademiaCategory::with(
            ['academia_category_language' => function ($query) use ($lang) {
                if ($lang) {
