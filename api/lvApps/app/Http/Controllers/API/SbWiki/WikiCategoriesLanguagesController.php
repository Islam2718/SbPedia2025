...
class NewsCategoriesLanguagesController extends Controller
{
    /**
    ...
    public function store(Request $request): Response
    {
        ...
        // if(Auth::guard('api')->check()){
            ...
            if($response = Language::create($request->all())){
     ...
     *
     * @param  \App\Models\Language  $country
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Models\Language  $widget
     * @return \Illuminate\Http\Response
     */
