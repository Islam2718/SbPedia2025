      ...
      <div class="col-md-8 col-sm-12">
        <div class="card mb-4">
          <div class="card-body">
              ...
              <div class="row mb-3">
                <label class="col-sm-12 col-form-label" for="basic-icon-default-fullname">Employee No</label>
                <div class="col-sm-12">
                  <div class="input-group input-group-merge">
                    <span
                      id="basic-icon-default-fullname2"
                    ...
                    <input
                      ...
                      v-model="formData.no_of_employee"
                      required
                    />
                  </div>
                </div>
...
export default defineComponent({
  ...
  methods: {
    async handleSubmit() {
      ...
      try {
        if (this.pageId) {
          const response = await (axios as any).put('https://api.aaatradeinternational.com/api/country/' + this.pageId,
            this.formData, 
            {
              headers: {
          ...
          const response = await (axios as any).post('https://api.aaatradeinternational.com/api/country', this.formData,
          {
            headers: {
              Authorization: `Bearer ${this.token}`,
            }
    ...
    async fetchData(id: number) {
      try {
        ...
        const response = await (axios as any).get(`https://api.aaatradeinternational.com/api/country/${id}`);
