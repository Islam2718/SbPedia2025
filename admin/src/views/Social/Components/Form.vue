          ...
          <div class="card-body text-center">
            <div class="page-image text-center">
              <img v-if="formData.image"
                  :src="'https://file.aaatradeinternational.com/'+formData.image"
                  alt="n/a"
              ...
              />
              <input type="text" class="form-control" placeholder="Enter Text" v-model="formData.image" />
            </div>
  ...
  methods: {
      ...
      try {
        if (this.pageId) {
          const response = await (axios as any).put(
            'https://api.aaatradeinternational.com/api/social/' + this.pageId,
            this.formData, 
            {
              headers: {
          ...
          const response = await (axios as any).post('https://api.aaatradeinternational.com/api/social', this.formData, {
            headers: {
              Authorization: `Bearer ${this.token}`,
            }
          });
    ...
    async fetchData(id: number) {
      try {
        ...
        const response = await (axios as any).get(`https://api.aaatradeinternational.com/api/social/${id}`, {
          headers: {
            Authorization: `Bearer ${this.token}`,
          },
        });
