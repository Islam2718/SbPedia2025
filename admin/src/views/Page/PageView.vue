            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="d-flex justify-content-between aling-items-center">
                ...
                <div>
                  ...
                  <router-link to="/page/form" class="btn btn-primary mt-2" >Add</router-link>
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <!-- table  -->
                    <div class="card mb-4" v-if="listShow">
                      <div class="card-body">
...
export default defineComponent({
  components: { Topbar, FooterView, List },
