                ...
                <div class="col-sm-12">
                  <div class="input-group input-group-merge">
                    ...
                    <input
                      ...
                      placeholder="Info-gallery title!"
                ...
                <div class="col-sm-12">
                  <div class="input-group input-group-merge">
                    ...
                    <input
                      ...
                      class="form-control"
                      placeholder="Info-gallery country!"
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-12">
                    <textarea 
                      ...
                      rows="10"
                      class="form-control"
                      placeholder="Info-gallery description!"
                    ></textarea>
                </div>
              </div>
          </div>
  ...
  methods: {
      ...
      try {
        if (this.pageId) {
          const response = await (axios as any).put(
            'https://api.aaatradeinternational.com/api/info-gallery/' + this.pageId,
            this.formData, 
            {
              headers: {
          ...
          const response = await (axios as any).post('https://api.aaatradeinternational.com/api/info-gallery', this.formData, {
            headers: {
              Authorization: `Bearer ${this.token}`,
            }
          });
    ...
    async fetchData(id: number) {
      try {
        ...
        const response = await (axios as any).get(`https://api.aaatradeinternational.com/api/info-gallery/${id}`, {
          headers: {
            Authorization: `Bearer ${this.token}`,
          },
        });
