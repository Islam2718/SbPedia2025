      ...
      <div class="col-md-8 col-sm-12">
        <div class="card mb-4">
          <div class="card-body">
              ...
              <div class="row mb-3">
                <label class="col-sm-12 col-form-label" for="basic-icon-default-fullname">Duration</label>
                <div class="col-sm-12">
                  <div class="input-group input-group-merge">
                    <span
                      id="basic-icon-default-fullname2"
              ...
              <div class="row mb-3">
                <label class="col-sm-12 col-form-label" for="basic-icon-default-fullname">NO. OF WORKERS</label>
                <div class="col-sm-12">
                  <div class="input-group input-group-merge">
                    <span
                      id="basic-icon-default-fullname2"
...
export default defineComponent({
  ...
  methods: {
    async handleSubmit() {
      ...
      try {
        if (this.pageId) {
          const response = await (axios as any).put('https://api.aaatradeinternational.com/api/client/' + this.pageId,
            this.formData, 
            {
              headers: {
          ...
          const response = await (axios as any).post('https://api.aaatradeinternational.com/api/client', this.formData,
          {
            headers: {
              Authorization: `Bearer ${this.token}`,
            }
    ...
    async fetchData(id: number) {
      try {
        ...
        const response = await (axios as any).get(`https://api.aaatradeinternational.com/api/client/${id}`);
