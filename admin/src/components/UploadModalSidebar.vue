      ...
      <div class="modal-content h-100">
        ...
        <div class="modal-footer">
          <span v-if="selectedImage">
            <button type="button" class="btn btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#sectionFormModal">Cancel</button>
            ...
            <button type="button" class="btn btn-primary mx-1" @click="pickedFileFunc()" data-bs-toggle="modal" data-bs-target="#sectionFormModal">Insert</button>
          </span>
          <span v-else>
            <button type="button" class="btn btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#sectionFormModal">Cancel</button>
